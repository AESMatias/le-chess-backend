...
exports.MovementIsValid = void 0;
const isAimSameColorPieces_1 = require("./isAimSameColorPieces");
const MovementIsValid = (board, pieceId, currentPosition, toPosition) => {
    let isValid = false;
    ...
    const recursivePathCheckVertical = (currentPosition, toPosition, direction) => {
        const currentRow = currentPosition['row'];
        const currentCol = currentPosition['col'];
        const toRow = toPosition['row'];
        const toCol = toPosition['col'];
        ...
        if (board[currentRow][currentCol] === '') {
            return recursivePathCheckVertical({ row: currentRow + direction, col: currentCol }, toPosition, direction);
        }
        return false;
    };
    const recursivePathCheckHorizontal = (currentPosition, toPosition, direction) => {
        const currentRow = currentPosition['row'];
        const currentCol = currentPosition['col'];
        const toRow = toPosition['row'];
        const toCol = toPosition['col'];
        ...
        if (board[currentRow][currentCol] === '') {
            return recursivePathCheckHorizontal({ row: currentRow, col: currentCol + direction }, toPosition, direction);
        }
        return false;
    };
    const recursivePathCheckDiagonal = (currentPosition, toPosition, directionRow, directionCol) => {
        const currentRow = currentPosition['row'];
        const currentCol = currentPosition['col'];
        const toRow = toPosition['row'];
        const toCol = toPosition['col'];
        ...
        if (board[currentRow][currentCol] === '') {
            return recursivePathCheckDiagonal({ row: currentRow + directionRow, col: currentCol + directionCol }, toPosition, directionRow, directionCol);
        }
        return false;
    };
    const isAimSameColor = (0, isAimSameColorPieces_1.isAimSameColorPieces)(board, currentPosition, toPosition);
    if (isAimSameColor) {
...
exports.MovementIsValid = MovementIsValid;
exports.default = exports.MovementIsValid;
